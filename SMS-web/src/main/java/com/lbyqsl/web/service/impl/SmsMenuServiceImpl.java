...
import com.lbyqsl.web.mapper.SmsMenuMapper;
import com.lbyqsl.web.service.SmsMenuService;
...
public class SmsMenuServiceImpl implements SmsMenuService {
    ...
    public List<Map<String, Object>> findUserMenu(Integer id) {
        ...
        while (parentIterator.hasNext()) {
            ...
            if (((Number) menu.get("type")).intValue() == 0) {
                // 是父级菜单
                data.add(menu);
        ...
        for (Map<String, Object> parentMenu : data) {
            ...
            while (sonIterator.hasNext()) {
                ...
                if (((Number) parentMenu.get("id")).longValue()
                        == ((Number) sonMenu.get("parentId")).longValue()) {
